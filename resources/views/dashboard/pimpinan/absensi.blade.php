...
<section class="w-full h-full">
    <div class="min-w-full">
        ...
        <div class="w-full flex flex-col md:flex-row items-center font-semibold justify-between mb-4">
            ...
            @if ($id_identitas)
                <a href="{{ route('dashboard-pimpinan-absensi') }}" class="px-5 py-2.5 w-full md:w-fit font-medium text-base bg-primary rounded-md justify-center flex flex-row text-white">
                        ...
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4 w-fit">
                                <div class="gap-2 grid grid-rows-1 grid-flow-col w-fit">
                                    ...
                                    @if (!$id_identitas)
                                        <a href="{{ route('dashboard-pimpinan-absensi') }}?user_id={{ $row->user_id }}&bulan={{ $inp_bulan }}&tahun={{ $inp_tahun }}" class="cursor-pointer px-1.5 py-1.5 bg-yellow-300 text-white w-fit rounded-md" type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
