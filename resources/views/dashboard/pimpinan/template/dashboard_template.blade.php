...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-white">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('dashboard-pimpinan') }}" class="hover:bg-blue-50 flex items-center p-3 group hover:text-primary @if( $sidebar == 'dashboard') bg-blue-50 text-primary @else text-gray-500 @endif rounded-lg">
            ...
            <li>
                <a href="{{ route('dashboard-pimpinan-absensi') }}" class="hover:bg-blue-50 flex items-center p-3 group hover:text-primary @if( $sidebar == 'absensi') bg-blue-50 text-primary @else text-gray-500 @endif rounded-lg">
            ...
            <li>
                <a href="{{ route('dashboard-pimpinan-logbook') }}" class="hover:bg-blue-50 flex items-center p-3 group hover:text-primary @if( $sidebar == 'logbook') bg-blue-50 text-primary @else text-gray-500 @endif rounded-lg">
